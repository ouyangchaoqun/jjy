...
<style>
    ...
    .asker_my_listen_list_box .question .img:before{background: #0BB20C; border-radius: 50%; width:2rem; height: 2rem; content: " "; display: block; margin-right:0.8235294117647059rem;  }
