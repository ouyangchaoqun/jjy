<template >
    <div  class="answer_bottom_box">
        ...
        <router-link to='/answer/ask/list'  :class="{on:tabOnIndex==2}" >
            <span class="icon ask"></span>待答
        </router-link>
        <router-link to='/answer/my/index' :class="{on:tabOnIndex==3}">
...
<style>
    ...
    .answer_bottom_box a:active,.answer_bottom_box a.on{ color:#0BB20C}
    ...
    .answer_bottom_box a .icon.ask{ background: url(../../../images/answer/tab_ask_list.png) no-repeat; background-size: 1.2rem;}
    ...
    .answer_bottom_box a:active .icon.ask,.answer_bottom_box a.on  .icon.ask{ background: url(../../../images/answer/tab_ask_list_on.png) no-repeat; background-size: 1.2rem;}
