...
<style>
    ...
    .answer_race_list  .list .item .img{ width: 2rem; height: 2rem; float:left; }
    .answer_race_list  .list .item .img img{ width: 100%; height: 100%; border-radius: 50%}
    .answer_race_list  .list .info{ float:left; margin-left:0.8823529411764706rem; width: 84% }
    .answer_race_list  .list .info .type{ font-size: 0.7rem;   color:#999; margin-bottom: 0.2rem; width: 8rem; float:right; text-align: right}
    .answer_race_list  .list .info .content{ font-size: 0.8823529411764706rem; line-height: 1.8; color:#333}
    .answer_race_list  .list .info .last_time{ float:left;font-size: 0.8823529411764706rem;color:#333; width: 6rem;
    }
    .answer_race_list  .list .info .price{ float:left;font-size: 0.8823529411764706rem;color:#333;   width: 7rem;}
