<template >
    <div style="height: 100%" class="answer_my_income_box wbg">
        ...
        <div class="nothing comment" v-if="income>0">
            <div>
        ...
        <div class="my_income"  v-if="income==0&&!showLoad">
            <div class="img"></div>
...
<style>
   ...
   .answer_my_income_box .money_dialog_detail .detail_input input{outline: none;height:100%;font-size: 2.4rem;color: rgba(255,157,24,1);text-shadow: 0px 0px 0px rgba(51,51,51,1);-webkit-text-fill-color: transparent;width:80%;float: left}
   ...
   .answer_my_income_box .dialog_btn{background: rgba(255,157,24,1);border:1px solid rgba(229,135,6,1);line-height: 2.647rem;font-size: 1.0588235rem;color:rgba(255,255,255,1);border-radius: 0.294rem;text-align: center;}
